...
class MainCharacter(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        chargement_image = (pygame.image.
                            load("data/MacGyver.png").convert_alpha())
...
class Boss(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        chargement_image = (pygame.image.
                            load("data/Gardien.png").convert_alpha())
        self.image = pygame.transform.scale(chargement_image, (30, 30))
        self.rect = self.image.get_rect()
        self.rect.x = 420
        self.rect.y = 420
...
class Text(pygame.sprite.Sprite):
    def __init__(self, location, scale_x, scale_y, rect_x, rect_y):
        ...
        self.image = pygame.transform.scale(chargement_image,
                                            (scale_x, scale_y))
        self.rect = self.image.get_rect()
        self.rect.x = rect_x
        self.rect.y = rect_y
